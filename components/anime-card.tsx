...
export function AnimeCard({ anime }: AnimeCardProps) {
    ...
    return (
        <Link
            href={href}
            className="group block relative overflow-hidden rounded-xl bg-slate-900 shadow-md hover:shadow-xl hover:shadow-violet-500/10 transition-all duration-300 transform hover:-translate-y-1"
        >
            <div className="aspect-[3/4] w-full overflow-hidden relative">
                ...
                <div className="absolute top-2 left-2 bg-purple-600 text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-sm">
                    {anime.type}
                </div>
            ...
            <div className="p-3">
                <h3 className="text-sm font-semibold text-gray-200 line-clamp-2 group-hover:text-violet-400 transition-colors">
                    {anime.title}
                </h3>
            </div>
        </Link>
